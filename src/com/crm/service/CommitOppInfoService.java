...
public class CommitOppInfoService {
	...
	public boolean checkCustCtc(CtcInfoEntityExtd ctcInfo){
		...
		try {
			...
			ResultSet rs=ctcInfoDao.getZ(conn, ctcInfo);
			while (rs.next()) {
				return true;
			}
	...
	public void commitOppInfo(OppInfoEntityExtd oppInfo) {
