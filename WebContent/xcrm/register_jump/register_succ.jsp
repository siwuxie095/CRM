...
<meta http-equiv="refresh" content="4;url=xcrm/nav/login.jsp" />
<title>注册成功</title>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
  			...
  			<div class="bar bar-success" id="processbar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width:0%">
