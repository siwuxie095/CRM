...
<%
	...
	ResultSet rs=oppInfoDao.getDtlByName(conn, oppInfo);
...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<div class="btn-group table-bordered">
			...
			<a href="<%= request.getContextPath() %>/xcrm/opp_mgt/mod_opp_info.jsp?oppId=<%= str[0] %>" class="btn"> <span class="add-on"><i class="icon-edit"></i></span>&nbsp;编辑</a>
		</div>
		<br/><br/>
